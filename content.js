window.addEventListener('DOMContentLoaded', function () {
    ...
    //     '.userpicture { display: none !important} #fixy-user, #fixy-content, .fixy .fixy-header { background: transparent} .fixy-inner, body, #mr-nav { background: #333 !important;} h3, h2, p, .snap-completion-meta a { color: white !important} .coursefullname { font-weight: 500 !important}' +
    //     '.completion-line { background: mediumpurple !important}';

    // const courseStyles = 'header, #mr-nav, #page, li, ul, div:not(.courseinfo):not(.courseinfo-body):not(.dynamicinfo):not(.coursegrade):not(.completionstatus):not(.completion-line):not(.breadcrumb-nav), footer, p, span, table, tr, table.boxaligncenter.generaltable.user-grade *{ background: #333 !important } h1, h2, h3, h4, h5, h6, p, a, li, span, i { color: white !important } input[type="submit"],input[type="text"],input[type="number"] { border-color: white !important; background: #e3e3e3 !important; color: black !important; } ' +
